...
model_path = Path(os.getenv("CAR_PRICE_MODEL_PATH", "artifacts/car_price_pipeline.joblib"))
CAR_PRICE_MODEL_PATH = model_path if model_path.is_absolute() else BASE_DIR / model_path
...
if env_bool("DJANGO_TRUST_PROXY_HEADER", default=False):
